...
public class QTextViewUtil {
	 ...
	 * 去掉HTML中的超链接和样式等
	 */
	public static void clearHtml(final TextView tv){
	...
	public static void formatHtmlWithAnchor(final Context ctx, final TextView tv, final int anchorColor, final boolean isAnchorUnderline, final AnchorClickListener listener){
	...
	public static void formatHtmlWithImage(final Context ctx, final TextView tv, String replaceStr, int resId){
		Spanned spd = Html.fromHtml(tv.getText().toString());
		CharSequence text = spd;
		//设置可点击
		tv.setMovementMethod(LinkMovementMethod.getInstance());
